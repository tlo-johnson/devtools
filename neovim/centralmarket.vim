...
command! JvDev call RunInTerminal('dev-server', 'cd ~/dev/central-market/joe-vs && yarn dev') | call RunInTerminal('redis-server', 'cd ~/dev/central-market/joe-vs && yarn dev:redis')
